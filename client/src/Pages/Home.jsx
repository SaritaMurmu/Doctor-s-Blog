                    ...
                    <div className="row">
                        <div className="col-lg-6 col-md-12 col-xl-7">
                            <div className="block">
                                ...
                                <p className="mb-4 pr-5">A repudiandae ipsam labore ipsa voluptatum quidem quae laudantium quisquam
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-4">
                            <div className="about-content pl-4 mt-4 mt-lg-0">
                                ...
                                <a href="/service" className="btn btn-main-2 btn-round-full btn-icon">Services<i
                        ...
                        <div className="col-lg-6 col-md-10 ">
                            <div className="appointment-wrap mt-5 mt-lg-0">
                                ...
                                <form id="#" className="appointment-form" method="post" action="#">
                                    ...
                                    <a className="btn btn-main btn-round-full" href="/appointment">Make Appoinment <i className="icofont-simple-right ml-2"></i></a>
                                </form>
                            </div>
                        </div>
                    </div>
                ...
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-lg-12 testimonial-wrap-2">
                            ...
                            <div className="testimonial-block style-2  gray-bg">
                                <div className="testimonial-thumb">
                                    <img src="./Assets/images/team/test-thumb2.jpg" alt="" className="img-fluid" />
                                </div>
                            ...
                            <div className="testimonial-block style-2  gray-bg">
                                <div className="testimonial-thumb">
                                    <img src="./Assets/images/team/test-thumb3.jpg" alt="" className="img-fluid" />
                                </div>
                            ...
                            <div className="testimonial-block style-2  gray-bg">
                                <div className="testimonial-thumb">
                                    <img src="./Assets/images/team/test-thumb4.jpg" alt="" className="img-fluid" />
                                </div>
